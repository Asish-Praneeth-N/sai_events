                ...
                <div className="pl-6 pr-5 py-5 space-y-4">
                  ...
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                        ...
                        <span>{booking.categories?.name} Service</span>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    <div className="space-y-2">
                      <p className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Event Scope</p>
                      <div className="space-y-1.5">
                        <div className="flex items-center gap-2 text-xs">
                          ...
                          <span className="text-zinc-700 dark:text-zinc-300 font-semibold">{req.guest_count} guests</span>
                        </div>
                        <div className="flex items-center gap-2 text-xs">
                          <svg className="w-3.5 h-3.5 text-zinc-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          <span className="text-zinc-700 dark:text-zinc-300 font-semibold">{req.location}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Services */}
                    <div className="space-y-2">
                      <p className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Services</p>
                      <div className="flex flex-wrap gap-1.5">
                        {categoryItems.map((item, idx) => (
                          <span key={idx} className="inline-flex items-center gap-1.5 px-3 py-1 text-xs bg-zinc-50 dark:bg-zinc-950 border border-border text-zinc-700 dark:text-zinc-300 rounded-xl">
                    ...
                    <div className="space-y-2">
                      ...
                      {isApproved ? (
                        <div className="p-3 rounded-xl bg-emerald-500/5 dark:bg-emerald-950/20 border border-emerald-200/40 dark:border-emerald-800/20 space-y-1">
                          <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-100">{req.profiles?.full_name}</p>
                        ...
                        <div className="p-3 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-border flex items-start gap-2">
