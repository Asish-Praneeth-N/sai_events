          ...
          {categories.map((cat, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative h-[210px] sm:h-[250px] rounded-2xl overflow-hidden border border-border hover:border-[#D4AF37]/40 transition-colors duration-500 cursor-pointer shadow-lg"
              >
