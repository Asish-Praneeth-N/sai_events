  ...
  return (
    <footer className="bg-[#090909] text-white border-t border-white/5 pt-16 pb-8 select-none font-sans">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
        ...
        <div className="md:col-span-5 space-y-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-base font-black text-white tracking-[0.25em] uppercase" style={{ fontFamily: "Playfair Display, serif" }}>
              Sai Events
            </span>
          </div>

          <p className="text-xs text-[#F7F3EC]/55 font-light leading-relaxed max-w-sm">
            ...
            {socialLinks.map((social, idx) => {
              ...
              return (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-white/5 border border-white/5 hover:border-[#D4AF37]/50 flex items-center justify-center text-white/65 hover:text-[#D4AF37] hover:scale-105 transition-all duration-300"
          ...
          <button
            ...
            className="flex items-center gap-2 text-[10px] uppercase tracking-[0.18em] text-[#F7F3EC]/35 hover:text-[#D4AF37] transition-colors duration-300 font-light group cursor-pointer"
          >
          ...
          <ul className="space-y-3">
            {quickLinks.map((link, idx) => (
              <li key={idx}>
                <a
                  href={link.href}
                  className="text-[11px] text-[#F7F3EC]/60 hover:text-[#D4AF37] transition-colors duration-300 font-light tracking-wide"
                >
                  {link.label}
                </a>
              </li>
          ...
          <div className="grid grid-cols-2 gap-2 max-w-[190px]">
            {instagramPreviews.map((img, idx) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="relative aspect-square overflow-hidden rounded-xl border border-white/5 hover:border-[#D4AF37]/40 block group bg-black transition-colors duration-300"
              >
                <img
                  src={img}
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-[10px] text-[#F7F3EC]/35 tracking-wider font-light">
          &copy; {currentYear} SAI EVENTS. All Rights Reserved. Crafted with Timeless Luxury.
        </p>
        <div className="flex gap-6">
          <a href="#home" className="text-[10px] text-[#F7F3EC]/35 hover:text-[#D4AF37] tracking-wider font-light transition-colors duration-300">
            Privacy Policy
          </a>
          <a href="#home" className="text-[10px] text-[#F7F3EC]/35 hover:text-[#D4AF37] tracking-wider font-light transition-colors duration-300">
            Terms of Service
