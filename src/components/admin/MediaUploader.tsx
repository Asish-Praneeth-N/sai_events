      ...
      <div className="flex flex-wrap gap-2">
        ...
        {value.length < limit && (
          <button
            ...
            className="w-20 h-20 flex flex-col items-center justify-center border-2 border-dashed border-border rounded-xl hover:border-accent-gold/50 hover:bg-accent-gold/5 transition-all duration-200 text-muted-foreground hover:text-accent-gold disabled:opacity-50 cursor-pointer"
          >
            {uploading ? (
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-[10px] font-semibold text-accent-gold">Uploading</span>
              </div>
